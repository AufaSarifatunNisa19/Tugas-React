...
export default function Card({product}) {
  return (
    <Link to={`/products/${product.slug}` ?? ''} className="flex flex-col max-w-[370px] flex-wrap p-[16px] bg-[#A0937D] hover:ring-opacity-40 active:ring-5 active:ring-[#A0937D]] hover:ring-4 active:ring-2 active:ring-opacity-90" >
